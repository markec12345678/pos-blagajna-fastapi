"""Employee scheduling improvements — optimization, availability, conflict resolution."""
...
router = APIRouter(prefix="/schedule-advanced", tags=["Napredni urnik"])
